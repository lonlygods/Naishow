...
var _add_site = _interopRequireDefault(__webpack_require__(/*! ./pages/add_site/add_site.vue */ 46));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _add_site_vue_vue_type_template_id_32138f1c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add_site.vue?vue&type=template&id=32138f1c& */ 47);
/* harmony import */ var _add_site_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add_site.vue?vue&type=script&lang=js& */ 49);
...
/* harmony import */ var _add_site_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./add_site.vue?vue&type=style&index=0&lang=css& */ 52);
...
var _area = _interopRequireDefault(__webpack_require__(/*! @/static/area.js */ 51));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var _default = { data: function data() {return { show: false, areaList: _area.default, carmodel: '', userName: '', telNumber: '', provinceName: '', cityName: '', countyName: '', detailInfo: '', nameMessage: '', phoneMessage: '' };}, onLoad: function onLoad() {// console.log(AreaList)
  }, methods: { site: function site() {var that = this;uni.chooseAddress({ success: function success(res) {console.log(res);that.userName = res.userName;that.telNumber = res.telNumber; // that.provinceName = res.provinceName;
    ...
    detailClick: function detailClick(event) {
